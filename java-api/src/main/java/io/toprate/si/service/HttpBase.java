...
public class HttpBase {
    ...
    <T> T get(Resource resource, Map<String, Object> params, Class<T> tClass) {
        ...
        HttpEntity<SearchResultDto> searchResultEntity = new HttpEntity<>(headers);

        ResponseEntity<T> response = restTemplate.exchange(buildParams(resource, params).toUriString(), HttpMethod.GET, searchResultEntity, tClass);
